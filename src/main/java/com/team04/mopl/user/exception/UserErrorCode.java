...
public enum UserErrorCode implements ErrorCode {
	...
	USER_PROFILE_ACCESS_DENIED(HttpStatus.FORBIDDEN, "US11", "본인의 프로필만 변경할 수 있습니다."),
	USER_INVALID_PROFILE_IMAGE(HttpStatus.BAD_REQUEST, "US12", "프로필 이미지는 10MB 이하의 이미지 파일만 업로드할 수 있습니다."),
